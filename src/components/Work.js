    ...
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-10'>
        ...
        className='flex-1 flex flex-col gap-y-12 mb-10 lg:mb-0'>
          <div>
            <h2 className='h2 leading-tight text-accent-white'>My latest <br/>
                work. 
            </h2>
          ...
          <div className='group relative overflow-hidden border-2 border-white/50 rounded-x1'>
            ...
            <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
              <span className='text-3x1 text-white'>AI created</span>
            </div>
        ...
        className='flex-1 flex flex-col gap-y-10'>
          <div className='group relative overflow-hidden border-2 border-white/50 rounded-x1'>
            ...
            <div className='absolute -bottom-full left-12 group-hover:bottom-24 transition-all duration-500 z-50'>
              <span className='text-gradient'>React.js Frontend website</span>
            </div>

            <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'>
              <span className='text-3x1 text-white'>SOAP1DAY</span>
            </div>
