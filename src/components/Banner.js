    ...
    <div className='container mx-auto'>
      <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
        <div className='flex-1 text-center font-secondary lg:text-left'>
         ...
         <motion.p variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}} className='mb-8 max-w-lg mx-auto lg:mx-0'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla id ligula ut sapien mattis porttitor. Etiam ut mattis ipsum. </motion.p>
         ...
         <motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.7}}  className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
          <a href='https://www.linkedin.com/in/max-roos-010a951b4/'>
           <FaLinkedin/>
          </a>
          <a href='https://github.com/MaxRoos04?tab=overview&from=2023-03-01&to=2023-03-05'>
            <FaGithub/>
          </a>
          <a href='https://www.instagram.com/maxroos_/'>
            <FaInstagram/>
          </a>
         </motion.div>
        </div>
